...
import ArgButton from '@/components/ArgButton.vue';
...
<template>
    <div :class="[isDarkMode ? 'dark' : '', 'min-h-screen flex flex-col']">
        <nav class="" :class="isHome ? 'text-white bg-xhome' : 'border-b border-x5'">
            <div class="container border-0! mx-auto px-4 py-3 flex items-center justify-between" :class="isHome ? ' text-white bg-xhome' : ''">
                ...
                <div class="flex items-center space-x-2">
                    <ArgButton as="a" severity="raised" href="#features" @click.prevent="animateToFeatureSection" class="max-sm:hidden hover:bg-gray-800 hover:border-gray-700"
                        >Features</ArgButton
                    >
        ...
        <footer class="border-t border-x4">
            <div class="container mx-auto px-4 py-4 text-center text-t2 text-sm">© 2025 Dokie. Inspired by Postman</div>
        </footer>
    </div>
</template>
