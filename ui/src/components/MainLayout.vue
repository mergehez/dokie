                    ...
                    >
                        <template #left>
                            <div class="flex justify-between">
                                ...
                                <ArgInput v-model="query" placeholder="Search" class="w-20! my-2 mr-2" :prefix-icon="Search" size="small" />
                            </div>
                        ...
                        <template #right>
                            ...
                            <div class="flex-1 flex flex-col overflow-y-auto h-full w-full">
                                ...
                                <div v-else class="text-center text-gray-500 dark:text-gray-400 mt-10">Select an endpoint from the tree view to see its details</div>
                            </div>
                        </template>
                    </Splitter>
                </div>
