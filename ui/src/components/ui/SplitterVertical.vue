...
<template>
    <div class="flex flex-col w-full h-full overflow-hidden" ref="splitterContainer">
        <div :class="twMerge('w-full overflow-auto flex flex-col relative gap-1', topClass)" :style="{ height: heights.top }">
            <slot name="top">
                <div class="p-4">
                    <p>Top Panel</p>
                </div>
        ...
        <div class="h-1 w-full bg-x2 hover:bg-x6 cursor-row-resize flex-shrink-0" @mousedown="startResize" title="Drag to resize"></div>
        <div :class="twMerge('w-full overflow-auto flex flex-col relative gap-1', bottomClass)" :style="{ height: heights.bottom }">
            <slot name="bottom">
                <div class="p-4">
                    <p>Bottom Panel</p>
                </div>
