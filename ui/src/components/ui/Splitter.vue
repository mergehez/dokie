...
<template>
    <div :class="twMerge('flex w-full h-full overflow-hidden border border-x4', props.class)" ref="splitterContainer">
        <div v-if="!leftHidden" :class="twMerge('h-full overflow-auto flex flex-col relative gap-1', props.leftClass)" :style="{ width: widths.left }">
            <slot name="left">
                <div class="p-4">
                    <p>Left Panel</p>
                </div>
        ...
        ></div>
        <div v-if="!rightHidden" :class="twMerge('h-full overflow-auto flex flex-col relative gap-1', props.rightClass)" :style="{ width: widths.right }">
            <slot name="right">
                <div class="p-4">
                    <p>Right Panel</p>
                </div>
