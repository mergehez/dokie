...
<template>
    <DragTabs :items="sidebar.selectedEndpoints" :on-change="(list) => (sidebar.selectedEndpoints = list)" class="w-full flex flex-wrap overflow-x-auto border-b border-x0 py-1">
        <template #tab="{ requiredClass, item: e, i }">
            <div
                ...
                :class="[requiredClass, sidebar.activeEndpoint?.id === e.id ? 'text-gray-900 dark:text-white border-b-green-700' : 'text-gray-700 dark:text-gray-300']"
